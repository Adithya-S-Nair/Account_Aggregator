            ...
            <div className='bg-neutral-50 w-full shadow-md fixed py-4 px-20'>
                <div className="flex items-center justify-between">
                    ...
                    <div className='flex items-center gap-x-8'>
                        <div className='flex items-center gap-2'>
                            <Link to="/branch/accountdetails">
                                <span className='font-normal hover:underline'>Account Details</span>
                            </Link>
                        </div>
                        <div className='flex items-center gap-2'>
                            <Link to="/branch/viewconsents">
                                <span className='font-normal hover:underline'>Consent Management</span>
                            </Link>
                        </div>
